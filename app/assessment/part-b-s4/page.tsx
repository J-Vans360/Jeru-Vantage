...
import assessmentData from '@/data/part-b-s4-social.json';
import { calculateSocialCheckScores } from '@/lib/scoring';
import SocialCheckResultsDisplay from '@/components/assessment/SocialCheckResultsDisplay';

const USER_ID = 'test-user-123';

export default function PartBS4Page() {
  ...
  const handleComplete = async (finalAnswers: Record<number, number>) => {
    const calculatedScores = calculateSocialCheckScores(finalAnswers, assessmentData);
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            <p className="text-sm text-blue-900">
              <strong>ℹ️ Note:</strong> {section.note}
            </p>
          </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="px-6 py-3 rounded-lg bg-rose-600 text-white font-medium hover:bg-rose-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            Next →
          </button>
        </div>
